        ...
        rx.vstack(
            ...
            rx.hstack(
                rx.cond(
                    ...
                    rx.icon("circle-x", size=20, color="#ef4444"),
                ),
                rx.text(
                    result.description,
                    font_weight="500",
        ...
        rx.vstack(
            ...
            rx.hstack(
                ...
                rx.cond(
                    ...
                    rx.hstack(
                        rx.spinner(size="1"),
                        rx.text("Running tests...", color="#6b7280"),
                        spacing="2",
                    ),
                    rx.cond(
                        total_count > 0,
                        rx.badge(
                            passed_count.to_string() + "/" + total_count.to_string() + " passed",
            ...
            rx.cond(
                ...
                rx.center(
                    rx.vstack(
                        rx.spinner(size="3"),
                        rx.text("Executing your code...", color="#6b7280"),
                        spacing="2",
                    ),
                    padding="2rem",
                    width="100%",
                ...
                rx.cond(
                    ...
                    rx.center(
                        rx.vstack(
                            rx.icon("circle-play", size=32, color="#9ca3af"),
                            rx.text(
            ...
            rx.cond(
                ...
                rx.box(
                    rx.hstack(
                        rx.icon("party-popper", size=20, color="#10b981"),
                        rx.text(
